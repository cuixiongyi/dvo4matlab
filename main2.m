...
%             [Jw, Jz] = computeJacobianOfProjectionAndTransformation(pointTmp, xpose, JZ_full, variable, devrative2x{ww}(yy,xx), devrative2y{ww}(yy,xx));
% %             J = [devrative2x{ww}(yy,xx), devrative2y{ww}(yy,xx)] * Jw - Jz;
%             J =   Jz;
%             lsList{ww}(ii,:) = J;
%             if sum(isnan(J))
%                 'nan in Jacobian'
